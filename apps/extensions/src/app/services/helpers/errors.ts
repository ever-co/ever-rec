...
export const useErrorHandler = () => {
  ...
  const customMessageErrors: Record<string, string> = {
    'The user did not approve access.': t('ext.errors.LoginWithGoogle'),
  };

  const firebaseErrors: Record<string, string> = {
    'auth/wrong-password': t('ext.errors.invalidEmailOrPassword'),
    'auth/popup-closed-by-user': '',
    'auth/claims-too-large': 'auth/claims-too-large',
    'auth/email-already-exists': t('ext.errors.userEmailExists'),
    'auth/email-already-in-use': t('ext.errors.userEmailExists'),
    ...
    'auth/invalid-email': t('ext.errors.invalidloginOrPassword'),
    ...
    'auth/invalid-password': t('ext.errors.invalidloginOrPassword'),
    ...
    'auth/user-not-found': t('ext.errors.userNotFound'),
  ...
  const errorHandler = (error: any) => {
    let errorMsg: string = t('ext.errors.thereWasAnError');
