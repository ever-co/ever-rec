...
import { IWorkspace, IWorkspaceDbFolder } from '@/app/interfaces/IWorkspace';
import { ITrelloData } from '@/app/interfaces/IIntegrationTypes';
import { PanelRoute } from '@/content/panel/panelRouter/panel.route';
...
export default class PanelAC {
  ...
  static setEditorImage({
    ...
    editorImage: IEditorImage | IWorkspace | null;
  }): ActionType {
  ...
  static setCurrentWorkspaceFolder({
    currentWorkspaceFolder,
  }: {
    currentWorkspaceFolder: IWorkspaceDbFolder | boolean | null;
  }): ActionType {
    return {
